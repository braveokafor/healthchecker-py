...
fmt:              ## Format code using black & isort.
	$(ENV_PREFIX)isort healthchecker/
	$(ENV_PREFIX)black -l 79 healthchecker/
...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=healthchecker -l --tb=short --maxfail=1 tests/
