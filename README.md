...
- 🎯 Entry points to execute your program using `python -m <healthchecker_py>` or `$ healthchecker_py` with basic CLI argument parsing.
...
Awesome healthchecker_py created by braveokafor

## Install it from PyPI

```bash
pip install healthchecker_py
```

## Usage

```py
from healthchecker_py import BaseClass
from healthchecker_py import base_function
